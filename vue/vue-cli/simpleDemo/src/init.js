...
var createTransformStyle = () =>{
    ...
    slideStyleDom.innerText = '.slide-right-enter, .slide-left-leave-to { transform: translateX(' + bodyWidth + 'px); } ' +
            '.slide-right-leave-to, .slide-left-enter { transform: translateX(-' + bodyWidth + 'px); }';
